...
const I18n = {
    ...
    messages: {
        'zh-CN': {
            ...
            'main.seconds': '秒',
            'main.mac': 'MAC 地址',
            'main.macPlaceholder': '如：AA:BB:CC:DD:EE:FF',
            'main.macHint': '已自动填充所选网卡的硬件地址，如有需要可手动修改',
            'main.interface': '网络接口',
            'main.interfaceHint': '选择用于接收远程唤醒/关机指令的网卡，多网卡设备请务必选择正确的网卡',
            'main.interfaceLoading': '正在加载网卡列表…',
            'main.interfaceNoneFound': '未检测到可用网卡',
            'main.interfaceUp': '已连接',
            'main.interfaceDown': '未连接',
            'main.interfaceUnverified': '当前配置，未在列表中检测到',
            'main.refreshInterfaces': '刷新网卡列表',
            'main.applyNetwork': '应用网络设置',
            ...
            'settings.managementPort': '管理端口',
            'settings.managementPortHelp': '修改后不会立即生效，需要重启 wolp 服务；重启后请改用新端口访问本页面',
            'settings.save': '保存设置',
            ...
            'error.port': '管理端口必须是 1-65535 之间的数字',
            'error.controlKey': '关机控制密钥必须为 6 字节十六进制数',
            'success.unchanged': '设置未变更',
            'success.saved': '设置已保存！',
            'success.portSaved': '端口已保存为 {port}，需要重启 wolp 服务后生效；重启后请改用新地址 http://<设备IP>:{port}/ 访问本页面',
            ...
            'error.loadInterfacesFailed': '获取网卡列表失败！',
            'error.interfaceRequired': '请选择一个网卡',
            'error.macRequired': 'MAC 地址不能为空',
            'error.networkApplyFailed': '应用网络设置失败！',
            'success.networkSaved': '网络设置已应用，正在使用所选网卡监听！'
        },
        en: {
            ...
            'main.macPlaceholder': 'e.g. AA:BB:CC:DD:EE:FF',
            'main.macHint': 'Auto-filled from the selected adapter\u2019s hardware address; edit manually if needed.',
            'main.interface': 'Network interface',
            'main.interfaceHint': 'Choose the adapter that should listen for the remote wake/shutdown signal. On multi-NIC machines, be sure to pick the correct one.',
            'main.interfaceLoading': 'Loading network interfaces…',
            'main.interfaceNoneFound': 'No network interfaces found',
            'main.interfaceUp': 'Up',
            'main.interfaceDown': 'Down',
            'main.interfaceUnverified': 'saved, not detected in current list',
            'main.refreshInterfaces': 'Refresh interface list',
            'main.applyNetwork': 'Apply network settings',
            ...
            'settings.managementPort': 'Management port',
            'settings.managementPortHelp': 'Not applied immediately — restart the wolp service, then use the new port to access this page.',
            ...
            'error.port': 'Management port must be a number between 1 and 65535',
            ...
            'success.portSaved': 'Port saved as {port}. Restart the wolp service for this to take effect, then browse to http://<device-ip>:{port}/ to access this page.',
            ...
            'error.loadInterfacesFailed': 'Failed to load the network interface list.',
            'error.interfaceRequired': 'Please select a network interface',
            'error.macRequired': 'MAC address cannot be empty',
            'error.networkApplyFailed': 'Failed to apply network settings!',
            'success.networkSaved': 'Network settings applied. Now listening on the selected interface!'
        }
    },
